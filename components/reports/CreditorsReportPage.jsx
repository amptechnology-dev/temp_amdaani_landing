        ...
        <>
          ...
          <div className="space-y-3">
            {vendors.map((vendor) => {
              ...
              const sortedInvoices = [...(vendor.invoices || [])].sort(
              ...
              return (
                ...
                >
                      ...
                      {(vendor.vendorMobile || vendor.vendorGstNumber) && (
                        <div className="flex items-center gap-3 mt-1 pl-6">
                          ...
                          {vendor.vendorGstNumber && (
                            <span className="text-xs text-slate-400">GST: {vendor.vendorGstNumber}</span>
                          )}
                        </div>
                      )}
                    </div>
                    <span className="text-xs text-slate-400 mr-3 shrink-0">
                      {vendor.totalInvoices || 0} invoices
                    </span>
                    {isExpanded ? (
                  ...
                  <div className="grid grid-cols-3 gap-4 px-5 py-3 border-t border-slate-100 bg-slate-50/50">
                    ...
                    <SummaryStat
                      label="Due"
                      value={currency(vendor.totalDueAmount)}
                      accent={num(vendor.totalDueAmount) > 0 ? "text-red-600" : "text-emerald-600"}
                    />
                  </div>
