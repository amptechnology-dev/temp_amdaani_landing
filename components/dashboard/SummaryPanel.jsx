...
export default function SummaryPanel({ dueSummary = {}, receivedSummary = {} }) {
  return (
    <div className="bg-white rounded-2xl border border-slate-200 p-4 h-full flex flex-col justify-center">
      ...
      <div className="flex divide-x divide-slate-100">
        ...
        <a
          ...
          className="flex-1 flex flex-col items-center text-center px-1 hover:opacity-80 transition-opacity"
        >
