...
// Payment form validation (mobile app er ReceivePaymentBottomSheet logic)
  ...
  const handlePaymentSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      const response = await api.post(
        `/invoice/add-payment/${selectedInvoice._id}`,
        {
      ...
      <div className={`min-h-screen w-full ${currentTheme.background}`}>
        <div className="max-w-4xl mx-auto p-4 sm:p-6">
          <div className="flex flex-col items-center justify-center py-24 text-center bg-white rounded-2xl border border-slate-200">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-1">Customer Not Found</h3>
            <p className="text-sm text-slate-400 max-w-sm mb-4">
              Unable to load customer due details. Please try again.
            </p>
    ...
    <div className={`min-h-screen w-full ${currentTheme.background}`}>
      <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <h2 className={`text-lg font-bold ${currentTheme.text}`}>Due Invoices</h2>
        ...
        <div className="space-y-3">
          {invoices.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center bg-white rounded-2xl border border-slate-200">
              ...
              <h3 className="text-base font-bold text-slate-800 mb-1">No Due Invoices</h3>
                ...
                initialValues={{
                  amount:
                    selectedInvoice.amountDue > 0
                      ? String(Math.round(selectedInvoice.amountDue))
                      : "",
                  paymentMethod: "cash",
                  note: "",
                }}
